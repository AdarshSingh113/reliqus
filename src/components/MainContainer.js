...
import Logo_Image from '../assets/Images/dummy-logo2 1.png'
import Background_Image from '../assets/Images/Rectangle 1.png'
import Message_LOGO from '../assets/Images/Group 2 (1).png'
const MainContainer = () => {
  ...
  return (
    <div className="w-full bg-green-300 flex-1 font-montserrat">
      ...
      <img  className="absolute bottom-20 right-8" src={Message_LOGO} alt="chat"/>
    </div>
  );
};
